...
--
-- Host: localhost
-- Generation Time: Aug 24, 2019 at 08:46 PM
...
(64, '2019_07_04_205800_create_runs_table', 1),
(65, '2019_07_11_192658_create_goals_table', 1);
...
ALTER TABLE `goals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `goals_user_id_index` (`user_id`);
...
ALTER TABLE `runs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `runs_user_id_index` (`user_id`);
